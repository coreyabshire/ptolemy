...
(
  ptolemy_id TEXT NOT NULL, -- The ptolemy id, using the notation we've adopted based on Stückelberger and Grasshoff's labeling method.
  ptolemy_name TEXT, -- The name we've taken into the spreadsheet as some translation from some source of the Ptolemy name for the place. In most cases this is the German from S&G, but in others it may be the English we've found from some other source.
  modern_name TEXT, -- The modern name as given in our spreadsheet, which denotes our best guess for the place that corresponds to the Ptolemy location.
